...
> Do NOT power the strip through the Pico — wire 5V directly from the LM2596S step-down output. Brightness capped at 50% in software to stay within the step-down's 3A limit.
